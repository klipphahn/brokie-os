...
export function merchListingCopy(productType) {
  ...
  if (key === "hat") {
    return {
      ...
      story: "A clean cap for jobsite mornings, errands, and off-duty hours."
    };
  }
  ...
  if (key === "sticker") {
    return {
      family,
      title: "Sticker",
      subtitle: "Die-cut sticker for laptops, toolboxes, water bottles, and hard hats.",
      badge: "STICKER",
  ...
  if (key === "long-sleeve") {
    return {
      ...
      story: "A versatile staple for in-between weather and longer shifts."
    };
  }
  ...
  return {
    ...
    story: "A heavyweight base layer for the people still building."
  };
}
...
export function buildListingDefaults({
  ...
  theme = "Built for the people still building."
} = {}) {
  ...
  const familyCopyMap = {
    apparel: {
      opener: "This is the kind of piece you grab when the day starts early and ends late.",
      body: "Built for the people clocking in, creating after hours, and still showing up tomorrow.",
      tags: ["streetwear", "workwear", "heavyweight", "the brokie"]
    },
    headwear: {
      opener: "A clean everyday cap with a low-key Brokie mark up front.",
      body: "Easy to throw on for jobsite mornings, weekend errands, and everything in between.",
      tags: ["hat", "cap", "headwear", "the brokie"]
    },
    sticker: {
      opener: "A small Brokie hit that goes wherever you do.",
      body: "Stick it on laptops, toolboxes, hard hats, water bottles, and anywhere you want the brand to live.",
