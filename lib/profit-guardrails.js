export const DEFAULT_PROFIT_POLICY = Object.freeze({
  ...
  // guardrail is advisory: margin/profit are still calculated and shown, but
  // launches are never blocked and no forced price-change approvals are
  // created — letting prices be set freely, like the Printful dashboard.
...
// Pure launch gate used by server helpers and publisher APIs. In advisory mode
// (enforceMinimumMargin === false) the margin floor never blocks a launch.
