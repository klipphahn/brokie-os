...
export function resolveBlankNameForProductType(
  ...
  if (normalized.includes("hoodie")) {
    return process.env.PRINTFUL_DEFAULT_HOODIE ||
      DEFAULT_BLANKS.hoodie;
  }
  if (normalized.includes("long sleeve")) {
    return process.env.PRINTFUL_DEFAULT_LONGSLEEVE ||
      DEFAULT_BLANKS["long-sleeve"];
  }
  ...
  return process.env.PRINTFUL_DEFAULT_BLANK ||
    DEFAULT_BLANKS.tee;
}
